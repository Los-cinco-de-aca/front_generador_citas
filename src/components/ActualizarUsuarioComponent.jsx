...
class ActualizarUsuarioComponent extends Component {
    ...
    componentDidMount() {
        UserService.getUsuarioById(this.state.idUsuario).then((res)=>{
    ...
    editarUsuario= (e)=>{
        ...
        UserService.editarUsuario(usuario).then(res =>{
                        ...
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.editarUsuario}>Guardar</button>
